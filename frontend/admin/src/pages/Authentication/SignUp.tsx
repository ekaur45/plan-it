...
import LogoDark from '../../images/planit.svg';
...
const userTypes:Array<{name:string,value:string}> = [
        ...
        <div className="flex flex-wrap items-center">
          <div className="hidden w-full xl:block xl:w-1/2">
            <div className="py-17.5 px-26 text-center">
              <Link className="mb-5 inline-block" to="//auth/signup">
                <img className="hidden dark:block" src={Logo} alt="Logo" width="250px" height="150px"/>
                <img className="dark:hidden" src={LogoDark} alt="Logo" width="250px" height="150px"/>
              </Link>
              <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Dignissimos quam quibusdam dolorum mollitia maxime alias fugiat quae aut labore reprehenderit? Sunt earum magnam neque in tenetur aliquam tempore enim. Nulla!</p>
             
              <span className="mt-15 mb-10 inline-block">
                <svg
                  width="350"
                  height="350"
                  viewBox="0 0 350 350"
          ...
          >
            <Listbox.Options className="z-10 absolute mt-1 max-h-60 w-full overflow-auto rounded-md bg-white py-1 text-base shadow-lg ring-1 ring-black/5 focus:outline-none sm:text-sm">
              {userTypes.map((person, personIdx) => (
                <Listbox.Option
                  key={personIdx}
                  className={({ active }) =>
                ...
                <div className="grid grid-cols-1 gap-x-2 gap-y-10 sm:grid-cols-2 lg:grid-cols-2 xl:gap-x-8">
                <div className="mb-4">
                  <label className="mb-2.5 block font-medium text-black dark:text-white">
                    First name
                  </label>
